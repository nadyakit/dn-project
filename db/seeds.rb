...
posts = [
{
	...
	category: category,
		...
		title: "Всё о&nbsp;белках",
		content: " <div> <h1>Общее</h1> </div> <p>Одно большое вареное яйцо содержит около 77 калорий, 6 г белка и 5 г здоровых жиров, а также почти все необходимые нам питательные вещества (проценты указаны от 100% дневной нормы):</p> <span>Селен — 22%</span><span>Витамин В2 — 15%</span><span>Витамин В12 — 9%</span><span>Витамин В5 — 7%</span><span>Фосфор — 9%</span><span>Витамин А — 6%</span><span>Фолиевая кислота — 5%</span> <div><h1>Замена</h1></div> <p>Витамин В12 больше всего содержится в рыбе, мясе, дрожжах, а так же
		молочных продуктах: сметана, молоко, творог, сыр.</p> <p>Фосфора больше всего содержится в грецких орехах, молочных и мясных продуктах, фасоли, в морской жирной рыбе, пшеничной муке, хлебе, в рисе и овощах.</p><p>Селен можно найти в цельнозерновом хлебе, крупах, семечках, мясе, а также в твороге. </p><p> Витамина В2 больше всего содержится в стручках бобовых, оболочке пшеницы, овса, ржи, а также он содержится в молоке и в его производных, в киви и в манке.</p>"
},
{
  section: section,
  category: category,
